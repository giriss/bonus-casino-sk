...
export default function Home() {
  return (
    <Main className="prose">
      ...
      <div className="grid md:grid-cols-4 lg:grid-cols-5 grid-cols-2 gap-4 mb-10">
        {images.map(([k, v, color]) => (
          <div key={k} className="card bg-base-100 shadow-sm">
            <figure className="p-5"  style={{margin: 0, ...(color ? { backgroundColor: color } : {})}}>
